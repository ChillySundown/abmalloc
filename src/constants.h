...
constexpr int PAGEMAP_TOTAL_BITS {34};

static_assert(PAGEMAP_ROOT_BITS + PAGEMAP_BRANCH_BITS + PAGEMAP_LEAF_BITS == PAGEMAP_TOTAL_BITS);
...
constexpr size_t n_pages_per_size[] = {1, 1, 1, 1, 1, 2, 2, 2};
